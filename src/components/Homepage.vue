  ...
  <section id="text">
    ...
    <div class="text__description">
      ...
      <p>
        ...
        improvement and of them was CSS loading. I will walk you through the
        process and show you how youcan improve your load times as well.
      </p>

      <p>
        To see how CSS affects the load time of a webpage we first have to know
        how the browser converts an HTML document into a functional webpage...
      </p>
      <div class="text__detail">
        <p>3 Min Read</p>

        <router-link :to="`/postdetails/2354571`">
          Read Full
  ...
  <section id="blog-posts">
    <article class="card">
      ...
      <div class="card__detail">
        <p>12 Min Read</p>
        <router-link :to="`/postdetails/2353289`">
          Read Full
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
            <path
              d="M438.6 278.6l-160 160C272.4 444.9 264.2 448 256 448s-16.38-3.125-22.62-9.375c-12.5-12.5-12.5-32.75 0-45.25L338.8 288H32C14.33 288 .0016 273.7 .0016 256S14.33 224 32 224h306.8l-105.4-105.4c-12.5-12.5-12.5-32.75 0-45.25s32.75-12.5 45.25 0l160 160C451.1 245.9 451.1 266.1 438.6 278.6z"
    ...
    <article class="card">
      ...
      <div class="card__description">
        ...
        <p>
          ...
          we can control the foreground and background color of an element with
      ...
      <div class="card__detail">
        ...
        <router-link :to="`/postdetails/2354605`">
          Read Full
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
            <path
              d="M438.6 278.6l-160 160C272.4 444.9 264.2 448 256 448s-16.38-3.125-22.62-9.375c-12.5-12.5-12.5-32.75 0-45.25L338.8 288H32C14.33 288 .0016 273.7 .0016 256S14.33 224 32 224h306.8l-105.4-105.4c-12.5-12.5-12.5-32.75 0-45.25s32.75-12.5 45.25 0l160 160C451.1 245.9 451.1 266.1 438.6 278.6z"
    ...
    <article class="card">
      ...
      <div class="card__detail">
        <p>10 Min Read</p>
        <router-link :to="`/postdetails/2354953`">
          Read Full
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
            <path
              d="M438.6 278.6l-160 160C272.4 444.9 264.2 448 256 448s-16.38-3.125-22.62-9.375c-12.5-12.5-12.5-32.75 0-45.25L338.8 288H32C14.33 288 .0016 273.7 .0016 256S14.33 224 32 224h306.8l-105.4-105.4c-12.5-12.5-12.5-32.75 0-45.25s32.75-12.5 45.25 0l160 160C451.1 245.9 451.1 266.1 438.6 278.6z"
    ...
    <article class="card">
      ...
      <div class="card__detail">
        <p>12 Min Read</p>
        <router-link :to="`/postdetails/2355053`">
          Read Full
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
            <path
              d="M438.6 278.6l-160 160C272.4 444.9 264.2 448 256 448s-16.38-3.125-22.62-9.375c-12.5-12.5-12.5-32.75 0-45.25L338.8 288H32C14.33 288 .0016 273.7 .0016 256S14.33 224 32 224h306.8l-105.4-105.4c-12.5-12.5-12.5-32.75 0-45.25s32.75-12.5 45.25 0l160 160C451.1 245.9 451.1 266.1 438.6 278.6z"
    ...
    <article class="card">
      ...
      <div class="card__detail">
        <p>8 Min Read</p>
        <router-link :to="`/postdetails/2354295`">
          Read Full
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
            <path
              d="M438.6 278.6l-160 160C272.4 444.9 264.2 448 256 448s-16.38-3.125-22.62-9.375c-12.5-12.5-12.5-32.75 0-45.25L338.8 288H32C14.33 288 .0016 273.7 .0016 256S14.33 224 32 224h306.8l-105.4-105.4c-12.5-12.5-12.5-32.75 0-45.25s32.75-12.5 45.25 0l160 160C451.1 245.9 451.1 266.1 438.6 278.6z"
    ...
    <article class="card">
      ...
      <div class="card__detail">
        <p>10 Min Read</p>
        <router-link :to="`/postdetails/2352577`">
          Read Full
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
            <path
              d="M438.6 278.6l-160 160C272.4 444.9 264.2 448 256 448s-16.38-3.125-22.62-9.375c-12.5-12.5-12.5-32.75 0-45.25L338.8 288H32C14.33 288 .0016 273.7 .0016 256S14.33 224 32 224h306.8l-105.4-105.4c-12.5-12.5-12.5-32.75 0-45.25s32.75-12.5 45.25 0l160 160C451.1 245.9 451.1 266.1 438.6 278.6z"
